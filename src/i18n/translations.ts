...
export const translations: Record<Lang, Translation> = {
  en: {
    ...
    about: {
      title: "About Me",
      p1: "Hello! I'm Dania Abdullah, a Software Engineering student at the University of Kurdistan Hewler (UKH).",
  ...
  tr: {
    ...
    about: {
      title: "Hakkımda",
      p1: "Merhaba! Ben Dania Abdullah, Kürdistan Hewler Üniversitesi'nde (UKH) Yazılım Mühendisliği okuyorum.",
  ...
  ku: {
    ...
    hero: {
      role: "خوێندکاری ئەندازیاری پرۆگرامسازی",
      welcome: "بەخێربێیت بۆ پۆرتفۆلیۆی دانیە عبداللە",
      downloadCV: "داگرتنی CV",
    },
    about: {
      title: "دەربارەی من",
      p1: "سڵاو! من دانیە عبداللە، خوێندکاری ئەندازیاری پرۆگرامسازیم لە زانکۆی کوردستان-هەولێر  لە ماوەی خوێندنم لە زانکۆ بەردوامم لە فەربوونی نویترین تەکنەلۆژیای سەردەم لە بوارەکەی خۆمدا  (UKH).",
      p2: "خوازیاری دروستکردنی چارەسەری پرۆگرامسازی مۆدێرنم، بە بەکارهێنانی React، TypeScript، Node.js و PostgreSQL.",
